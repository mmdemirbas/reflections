 ...
 */
fun <T : Annotation> KClass<T>.newAnnotation(vararg properties: Pair<String, Any>) = java.newAnnotation(*properties)

/**
 * Creates an instance of this annotation type.
 */
fun <T : Annotation> Class<T>.newAnnotation(vararg properties: Pair<String, Any>): T {
