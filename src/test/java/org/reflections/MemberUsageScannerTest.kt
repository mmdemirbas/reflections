...
class MemberUsageScannerTest {
    ...
    inner class Usages {
        ...
        @Test
        fun `ctor - with param`() {
            assertToStringEqualsSorted(setOf(TestModel.Usage.C2::class.java.getDeclaredMethod("method")),
                                       scanner.usages(TestModel.Usage.C1::class.java.getDeclaredConstructor(TestModel.Usage.C2::class.java)))
        }
        ...
        fun `method - with param`() {
            assertToStringEqualsSorted(setOf(TestModel.Usage.C2::class.java.getDeclaredMethod("method")),
                                       scanner.usages(TestModel.Usage.C1::class.java.getDeclaredMethod("method",
                                                                                                       String::class.java)))
        }
        ...
        fun field() {
            assertToStringEqualsSorted(setOf(TestModel.Usage.C1::class.java.getDeclaredConstructor(),
                                             TestModel.Usage.C1::class.java.getDeclaredConstructor(TestModel.Usage.C2::class.java),
                                             TestModel.Usage.C1::class.java.getDeclaredMethod("method"),
                                             TestModel.Usage.C1::class.java.getDeclaredMethod("method",
                                                                                              String::class.java)),
                                       scanner.usages(TestModel.Usage.C1::class.java.getDeclaredField("c2")).toSet())
        }
    }
}