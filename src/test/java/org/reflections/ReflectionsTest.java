...
public class ReflectionsTest {
    ...
    public void testMethodParameter() {
        try {
            ...
            assertThat(reflections.getMethodsReturn(String.class),
                       are(C4.class.getDeclaredMethod("m3"),
            ...
            assertThat(reflections.getMethodsWithAnyParamAnnotated(new AM1() {
                @Override
                public String value() { return "2"; }
    ...
    public void testConstructorParameter() throws NoSuchMethodException {
        ...
        assertThat(reflections.getConstructorsMatchParams(),
                   are(C1.class.getDeclaredConstructor(),
                       ...
                       Usage.C1.class.getDeclaredConstructor(),
                       Usage.C2.class.getDeclaredConstructor()));

        assertThat(reflections.getConstructorsWithAnyParamAnnotated(AM1.class),
                   are(C4.class.getDeclaredConstructor(String.class)));

        assertThat(reflections.getConstructorsWithAnyParamAnnotated(new AM1() {
            @Override
            public String value() { return "1"; }
    ...
    public void testMethodParameterNames() throws NoSuchMethodException {
        assertEquals(reflections.getMethodParamNames(C4.class.getDeclaredMethod("m3")), Lists.newArrayList());
    ...
    public static <T> Matcher<Set<? super T>> are(T... ts) {
        Collection<?> c1 = Arrays.asList(ts);
    ...
    private Matcher<Set<Class<?>>> annotatedWith(Class<? extends Annotation> annotation) {
    ...
    private Matcher<Set<Class<?>>> metaAnnotatedWith(Class<? extends Annotation> annotation) {
        return new Match<Set<Class<?>>>() {
            @Override
            public boolean matches(Object o) {
                for (Class<?> c : (Iterable<Class<?>>) o) {
    ...
    private Iterable<Class<? extends Annotation>> annotationTypes(Iterable<? extends Annotation> annotations) {
