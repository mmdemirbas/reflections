...
open class ReflectionsTest {
    ...
    fun testTypesAnnotatedWith() {
        assertToStringEqualsSorted(setOf(AI1::class.java), configuration.getTypesAnnotatedWith(MAI1::class.java, true))
        assertAnnotatedWith(MAI1::class.java, configuration.getTypesAnnotatedWith(MAI1::class.java, true))

        assertToStringEqualsSorted(setOf(I2::class.java), configuration.getTypesAnnotatedWith(AI2::class.java, true))
        assertAnnotatedWith(AI2::class.java, configuration.getTypesAnnotatedWith(AI2::class.java, true))

        assertToStringEqualsSorted(setOf(C1::class.java, C2::class.java, C3::class.java, C5::class.java),
        ...
        assertToStringEqualsSorted(setOf(C1::class.java), configuration.getTypesAnnotatedWith(AC1n::class.java, true))
        assertAnnotatedWith(AC1n::class.java, configuration.getTypesAnnotatedWith(AC1n::class.java, true))

        assertToStringEqualsSorted(setOf(AI1::class.java,
                                         I1::class.java,
                                         I2::class.java,
                                         C1::class.java,
                                         C2::class.java,
        ...
        assertToStringEqualsSorted(setOf(I1::class.java,
                                         I2::class.java,
                                         C1::class.java,
                                         C2::class.java,
                                         C3::class.java,
        ...
        assertToStringEqualsSorted(setOf(I2::class.java,
                                         ...
                                         C2::class.java,
                                         C3::class.java,
                                         C5::class.java), configuration.getTypesAnnotatedWith(AI2::class.java, false))
        assertMetaAnnotatedWith(AI2::class.java, configuration.getTypesAnnotatedWith(AI2::class.java, false))

        assertToStringEqualsSorted(emptySet(), configuration.getTypesAnnotatedWith(AM1::class.java, false))
    ...
    fun testFieldsAnnotatedWith() {
        assertToStringEqualsSorted(setOf(C4::class.java.getDeclaredField("f1"), C4::class.java.getDeclaredField("f2")),
    ...
    fun testMethodParameterNames() {
        assertToStringEqualsSorted(emptyList<Any>(), configuration.paramNames(C4::class.java.getDeclaredMethod("m3")))
