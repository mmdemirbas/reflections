...
class MethodParameterScannerTest {
    ...
    inner class MethodsMatchParams {
        private val scanner = MethodParameterScanner()
            ...
            assertToStringEqualsSorted(setOf(TestModel.C4::class.java.getDeclaredMethod(
                    "m1"),
                                             ...
                                             TestModel.Usage.C2::class.java.getDeclaredMethod(
                                                                     "method")), scanner.methodsWithParamTypes())
        }
    ...
    inner class MethodsReturns {
        ...
        fun primitive() {
            assertToStringEqualsSorted(setOf(TestModel.C4::class.java.getDeclaredMethod(
                    "add",
                    Int::class.javaPrimitiveType,
                    Int::class.javaPrimitiveType)), scanner.methodsWithReturnType(Int::class.javaPrimitiveType!!))
        }
    }
    ...
    inner class MethodsWithAnyParamAnnotated {
        ...
        fun `by instance`() {
            assertToStringEqualsSorted(setOf(TestModel.C4::class.java.getDeclaredMethod(
                    "m4",
                    String::class.java)),
                                                       scanner.methodsWithAnyParamAnnotated(JavaSpecific.newAM1(
                                                               "2")))
        }
    ...
    inner class ConstructorMatchParams {
        ...
        fun `single param`() {
            assertToStringEqualsSorted(setOf(TestModel.C4::class.java.getDeclaredConstructor(
                    String::class.java)), scanner.constructorsWithParamTypes(String::class.java))
        }
    }
    ...
    inner class ConstructorsWithAnyParamAnnotated {
        ...
        fun `by instance`() {
            assertToStringEqualsSorted(setOf(TestModel.C4::class.java.getDeclaredConstructor(
                    String::class.java)),
                                                       scanner.constructorsWithAnyParamAnnotated(JavaSpecific.newAM1(
                                                               "1")))
        }
