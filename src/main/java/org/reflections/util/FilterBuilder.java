...
public class FilterBuilder implements Predicate<String> {
    ...
    private FilterBuilder(Iterable<Predicate<String>> filters) {chain = Lists.newArrayList(filters);}

    /**
     * include a regular expression
     */
    public FilterBuilder include(String regex) {return add(new Include(regex));}
     ...
     */
    public FilterBuilder includePackage(Class<?> aClass) {return add(new Include(packageNameRegex(aClass)));}

    /**
     * exclude a package of a given class
     */
    public FilterBuilder excludePackage(Class<?> aClass) {return add(new Exclude(packageNameRegex(aClass)));}
     ...
     */
    public FilterBuilder excludePackage(String prefix) {return add(new Exclude(prefix(prefix)));}
    ...
    @Override
    public String toString() {return Joiner.on(", ").join(chain);}
    ...
    public abstract static class Matcher implements Predicate<String> {
        ...
        public Matcher(String regex) {pattern = Pattern.compile(regex);}
    ...
    public static class Include extends Matcher {
        ...
        public Include(String patternString) {super(patternString);}

        @Override
        public boolean apply(String regex) {return pattern.matcher(regex).matches();}
    ...
    public static class Exclude extends Matcher {
        ...
        public Exclude(String patternString) {super(patternString);}
