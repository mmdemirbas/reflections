 ...
 * <p>use the {@link org.reflections.vfs.Vfs#fromURL(java.net.URL)} to get a {@link Dir},
 ...
 *      }
 * </pre>
 * <p>{@link org.reflections.vfs.Vfs#fromURL(java.net.URL)} uses static {@link DefaultUrlTypes} to resolve URLs.
 ...
 * <p>It can be plugged in with other {@link UrlType} using {@link org.reflections.vfs.Vfs#addDefaultURLTypes(UrlType)} or {@link org.reflections.vfs.Vfs#setDefaultURLTypes(java.util.List)}.
 * <p>for example:
 * <pre>
...
public abstract class Vfs {
    ...
    public static Dir fromURL(URL url, List<UrlType> urlTypes) {
        ...
        throw new ReflectionsException(
                "could not create Vfs.Dir from url, no matching UrlType was found [" + url.toExternalForm() + "]\n"
